...
class B_Model(BaseModel):
    ...
    def optimize_parameters(self, step, scaler):
        ...
        ken_loss, param_loss, self.fake_K = self.custom_loss(params, self.ker_map, self.real_K)
        l_all += ken_loss
        l_all += param_loss
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            ken_loss, param_loss, fake_K = self.custom_loss(params, self.ker_map, self.real_K)
